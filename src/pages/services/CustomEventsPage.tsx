          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5">
                ...
                <p className="mt-6 text-[#94A3B8] font-light leading-relaxed tracking-wide text-lg" style={{ fontFamily: "'Inter', sans-serif" }}>
                  From themed galas to intimate milestones, our custom events are designed with creative direction and seamless production to match your vision.
                </p>
            </div>
            <div className="lg:col-span-7">
              <div className="relative rounded-[2.5rem] overflow-hidden border border-[#D4AF37]/10 bg-[#0B1320] w-full max-w-[513px] md:max-w-[593px] lg:max-w-[673px] mx-auto h-auto md:h-[420px]">
                <img src="/cus1.jpg" alt="" className="block w-full h-auto md:absolute md:inset-0 md:h-full md:w-full md:object-cover" loading="lazy" decoding="async" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 lg:order-1">
              <div className="relative rounded-[2.5rem] overflow-hidden border border-[#D4AF37]/10 bg-[#0A1118] w-full max-w-[513px] md:max-w-[593px] lg:max-w-[673px] mx-auto h-auto md:h-[420px]">
                <img src="/cus2.jpg" alt="" className="block w-full h-auto md:absolute md:inset-0 md:h-full md:w-full md:object-cover" loading="lazy" decoding="async" />
                <div className="absolute inset-0 bg-black/20" />
              </div>
            </div>
            <div className="lg:col-span-5 lg:order-2">
              ...
              <p className="mt-6 text-[#94A3B8] font-light leading-relaxed tracking-wide text-lg" style={{ fontFamily: "'Inter', sans-serif" }}>
                Creative direction, timelines, and technical production are coordinated to ensure a flawless guest experience.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 animate-in fade-in-0 slide-in-from-bottom-6 duration-700">
        <div className="max-w-[1600px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="relative rounded-[2.5rem] overflow-hidden border border-[#D4AF37]/10 bg-[#0B1320] w-full max-w-[513px] md:max-w-[593px] lg:max-w-[673px] mx-auto h-auto md:h-[420px]">
                <img src="/cus3.jpg" alt="" className="block w-full h-auto md:absolute md:inset-0 md:h-full md:w-full md:object-cover" loading="lazy" decoding="async" />
                <div className="absolute inset-0 bg-black/20" />
              </div>
            </div>
          </div>
